module OmniauthMacros
 ...
 "info"=>{"nickname"=>"test_user@tut.by", "email"=>"test_user@tut.by", "name"=>"Геннадий Батькович"},
 "extra"=>
  {"raw_info"=>
    {"first_name"=>"Геннадий",
     "last_name"=>"Батькович",
 ...
 "info"=>{"email"=>"test_user@mail.ru", "name"=>"Henadzi Simonovich"},
 "extra"=>{"raw_info"=>{"name"=>"Henadzi Simonovich", "email"=>"test_user@mail.ru", "id"=>"10209738170170964"}}}
